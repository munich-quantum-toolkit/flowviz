...
struct TooltipMetricsView: View {
  ...
  var body: some View {
    VStack(alignment: .leading, spacing: 10) {
      ...
      Label(
        String(format: "Duration: %.2fs", currentStep.actionDuration),
        systemImage: "clock.arrow.trianglehead.clockwise.rotate.90.path.dotted")
      Label(
      ...
      Label(
        String(format: "Liveness: %.2f", currentStep.liveness), systemImage: "waveform.path.ecg")
      Label(
